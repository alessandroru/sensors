(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.charts-google-bar', {
            ...
            templateUrl: 'app/sensor/charts/google-bar.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-google-scatter', {
            ...
            templateUrl: 'app/sensor/charts/google-scatter.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-google-line', {
            ...
            templateUrl: 'app/sensor/charts/google-line.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-chartjs-bar', {
            ...
            templateUrl: 'app/sensor/charts/chartjs-bar.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-chartjs-pie', {
            ...
            templateUrl: 'app/sensor/charts/chartjs-pie.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-chartjs-ticker', {
            ...
            templateUrl: 'app/sensor/charts/chartjs-ticker.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-chartjs-line', {
            ...
            templateUrl: 'app/sensor/charts/chartjs-line.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-d3-scatter', {
            ...
            templateUrl: 'app/sensor/charts/d3-scatter.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-d3-bar', {
            url: '/charts/d3/bar',
            templateUrl: 'app/sensor/charts/d3-bar.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
        ...
        .state('triangular.charts-d3-multiline', {
            ...
            templateUrl: 'app/sensor/charts/d3-multiline.tmpl.html',
            data: {
                permissions: {
                    only: ['viewCharts']
                },
