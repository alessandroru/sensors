(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.standard-page',  {
            ...
            templateUrl: 'app/sensor/layouts/standard-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.no-scroll-page',  {
            ...
            templateUrl: 'app/sensor/layouts/no-scroll-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.layouts-composer', {
            ...
            templateUrl: 'app/sensor/layouts/composer.tmpl.html',
