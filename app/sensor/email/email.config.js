(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider, EMAIL_ROUTES) {
        ...
        .state('triangular.email',  {
            ...
            views: {
                'toolbar@triangular': {
                    templateUrl: 'app/sensor/email/layout/toolbar/toolbar.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state, {
                ...
                views: {
                    '@triangular': {
                        templateUrl: 'app/sensor/email/inbox.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state + '.email', {
                url: '/mail/:emailID',
                templateUrl: 'app/sensor/email/email.tmpl.html',
