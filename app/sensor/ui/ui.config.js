(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.ui-typography', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/typography.tmpl.html'
        })
        .state('triangular.ui-colors', {
            url: '/ui/colors',
            controller: 'ColorsController',
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/colors.tmpl.html'
        })
        .state('triangular.ui-material-icons', {
            url: '/ui/material-icons',
            controller: 'MaterialIconsController',
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/material-icons.tmpl.html',
            resolve: {
        ...
        .state('triangular.ui-weather-icons', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/weather-icons.tmpl.html'
        })
        .state('triangular.ui-fa-icons', {
            url: '/ui/fa-icons',
            controller: 'FaIconsController',
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/fa-icons.tmpl.html',
            resolve: {
                icons: function($http, API_CONFIG) {
                    return $http({
                        method: 'GET',
        ...
        .state('triangular.ui-toolbar', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/toolbars.tmpl.html'
        })
        ...
        .state('triangular.ui-skins', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/ui/skins.tmpl.html'
        });
