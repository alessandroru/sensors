(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.menu-levels', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/menu/level.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.menu-dynamic', {
            ...
            controllerAs: 'vm',
            templateUrl: 'app/sensor/menu/dynamic.tmpl.html',
            data: {
                layout: {
                    contentClass: 'layout-column'
                }
        ...
        .state('triangular.menu-dynamic-dummy-page', {
            ...
            templateUrl: 'app/sensor/menu/dynamic-page.tmpl.html',
            data: {
                layout: {
                    contentClass: 'layout-column'
                }
            ...
            children: [{
                ...
                click: ['$mdDialog', function($mdDialog) {
                    $mdDialog.show(
                        ...
                        .htmlContent('You can now set menu item click events when you configure your menu as well as routes!.  See <code>app/sensor/menu/menu.config.js</code> to learn how.')
                        .ok('Got it Thanks.')
                    );
                }]
            },{
