        ...
        .state('triangular.calendar', {
            ...
            views: {
                '@triangular': {
                    ...
                    templateUrl: 'app/sensor/calendar/calendar.tmpl.html',
                    // set the controller to load for this page
                    controller: 'CalendarController',
                    controllerAs: 'vm'
                },
                'toolbar@triangular': {
                    templateUrl: 'app/sensor/calendar/layouts/toolbar/toolbar.tmpl.html',
                    controller: 'CalendarToolbarController',
                    controllerAs: 'vm'
                },
                'belowContent@triangular': {
                    templateUrl: 'app/sensor/calendar/calendar-fabs.tmpl.html',
