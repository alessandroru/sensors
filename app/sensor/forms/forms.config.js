(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.forms-inputs', {
            url: '/forms/inputs',
            templateUrl: 'app/sensor/forms/inputs.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.forms-binding', {
            url: '/forms/binding',
            templateUrl: 'app/sensor/forms/binding.tmpl.html',
            data: {
                layout: {
                    contentClass: 'layout-column'
                }
        ...
        .state('triangular.forms-autocomplete', {
            ...
            templateUrl: 'app/sensor/forms/autocomplete.tmpl.html',
            data: {
                layout: {
                    contentClass: 'layout-column'
                }
        ...
        .state('triangular.forms-wizard', {
            url: '/forms/wizard',
            templateUrl: 'app/sensor/forms/wizard.tmpl.html',
        ...
        .state('triangular.forms-validation', {
            ...
            templateUrl: 'app/sensor/forms/validation.tmpl.html',
            data: {
                layout: {
                    contentClass: 'layout-column'
                }
